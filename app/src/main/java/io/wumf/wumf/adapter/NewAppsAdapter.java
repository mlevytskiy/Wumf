 ...
 */
public class NewAppsAdapter extends RecyclerView.Adapter<TimelineViewHolder> {

    private List<App> apps;

    public NewAppsAdapter(List<App> apps) {
        this.apps = apps;
        this.setHasStableIds(true);
    }

    public NewAppsAdapter(final Context context, final long lastDateFilter) {
        apps = new ArrayList<>();
        this.setHasStableIds(true);
        new AsyncTask<Void, Void, List<App>>() {
            ...
            protected void onPreExecute() {
                ...
                RealmResults<App> realmResults = Realm.getDefaultInstance().where(App.class).greaterThan("installDate", lastDateFilter).findAll();
            ...
            protected void onPostExecute(List<App> apps) {
                ...
                NewAppsAdapter.this.apps.addAll(apps);
