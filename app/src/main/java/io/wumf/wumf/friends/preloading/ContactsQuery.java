...
import io.wumf.wumf.util.Utils;
...
public interface ContactsQuery {
    ...
    // A content MAIN_SERVER_URI for the Contacts table
    final static Uri CONTENT_URI = ContactsContract.CommonDataKinds.Phone.CONTENT_URI;//Contacts.CONTENT_URI;
    ...
    final static String[] PROJECTION = {
            ...
            // a "permanent" contact MAIN_SERVER_URI.
